		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<a href="<?php echo site_url('pegawai/create') ?>"><button type="button" class="btn btn-default">Masukkan data pegawai baru</button></a>
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" class="btn btn-danger" onclick="return konfirmasi()">Delete</a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
